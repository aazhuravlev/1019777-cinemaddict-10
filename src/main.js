...
const createFilmPopupTemplate = () => `<section class="film-details" style="display: none">
...
const createProfileStatusTemplate = () => `<section class="header__profile profile">
...
const createExtraListTemplate = () => `<section class="films-list--extra">
